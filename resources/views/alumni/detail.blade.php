        ...
        <div class="row">
            <div class="col-md-8 offset-2">
                ...
                <div class="block-content">
                    <h5>سوابق تحصیلات حوزوی</h5>
                    <label class="control-label"><strong>آخرین پایه تحصیلی : </strong>{{$alumniAssociation->seminaryGrade->title}}</label>
                    <table class="table">
                        <thead>
                        <tr>
                            <th>
                ...
                <div class="block-content">
                    <h5>مجوز تدریس دروس معارف اسلامی</h5>
                    <table class="table">
                        <thead>
                        <tr>
                            <th>
                ...
                <div class="block-content">
                    <h5>مجوز تبلیغ در دانشگاه ها</h5>
                    <table class="table">
                        <thead>
                        <tr>
                            <th>
                    ...
                    <table class="table">
                        ...
                        @foreach($scientificReferences as $scientificReference)
                            <tr>
                                ...
                                <td>
                                    {{$scientificReference->relation_type}}
                                </td>
                                <td>
                                    {{$scientificReference->acquaintance_method}}
                                </td>
                                <td>
